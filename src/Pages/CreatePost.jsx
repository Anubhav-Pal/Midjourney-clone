...
const CreatePost = () => {
  ...
  // Navigate back to the home page once a post is created
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Create imaginative and stunning images generateed by Dall-e and share them with community.</p>
      </div>
